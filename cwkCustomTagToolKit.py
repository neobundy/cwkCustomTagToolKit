...
#
#  CWK Custom Tag ToolKit
#

class CwkCustomTagToolKit(sublime_plugin.TextCommand,):

	def __init__(self, *args, **kwargs):
		sublime_plugin.TextCommand.__init__(self, *args, **kwargs)

	def run(self, edit, opening_tag="", closing_tag="", sub_opening_tag="", sub_closing_tag="", attr="", sub_attr="", use_header=False, use_sub_header=False, sub_header_delimiter="|"):
